    ...
    >
        ...
        <ModalBody>
            {props.postError !== "" ?
                ...
                : props.postError.includes("500") ? <p>Obs! Noe stemmer ikke på serveren.  <br/> {props.postError}</p>
                : <p>Noe gikk galt! <br/> {props.postError}</p>) : <p>En ny melding med endringene er lagret.</p>}
        </ModalBody>
        <ModalFooter>
            {props.postError !== "" ?
               <>
