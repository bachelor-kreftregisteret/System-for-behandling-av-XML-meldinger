...
public class MeldingController {
    MessageManager meldingManager;

    @Autowired
    public MeldingController(MessageManager meldingManager) throws IOException {
        this.meldingManager = meldingManager;
        meldingManager.addMeldingerFromUtFolderToMsgList();
    }
