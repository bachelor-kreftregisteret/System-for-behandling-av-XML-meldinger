...
@XmlRootElement(name = "Laboratorium", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0")
public class Laboratorium {

    @XmlElement(name = "LabnavnKRG", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "")
    protected String labnavnKRG;
    @XmlElement(name = "LabnavnHF", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "")
    protected String labnavnHF;
    @XmlElement(name = "LabnavnHFIkkeRelevant", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0")
    protected boolean labnavnHFIkkeRelevant;
    @XmlElement(name = "LabnavnHFSpesifiser", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "")
    protected String labnavnHFSpesifiser;
    @XmlElement(name = "Preparatnummer", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "")
    protected String preparatnummer;
    @XmlElement(name = "Labkode", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "")
