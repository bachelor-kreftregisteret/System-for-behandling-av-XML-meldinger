 ...
 *               &lt;enumeration value="KliniskProstataUtredning"/&gt;
 *             &lt;/restriction&gt;
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
...
public class Meldingsinformasjon {
    ...
    @XmlElement(name = "VersjonsNrOriginal", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true)
    protected String versjonsNrOriginal;
    @XmlElement(name = "KRG_GUID", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "")
    protected String krgguid;
    @XmlElement(name = "VersjonIP", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "0")
    protected BigInteger versjonIP;
    @XmlElement(name = "VersjonBT", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "0")
    protected BigInteger versjonBT;
    @XmlElement(name = "TidspunktSubmit", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true)
    protected String tidspunktSubmit;
    @XmlElement(name = "Brukernavn", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "")
    protected String brukernavn;
    @XmlElement(name = "Filnavn", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "")
    protected String filnavn;
    @XmlElement(name = "VersjonInternEkstern", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0", required = true, defaultValue = "0")
    protected String versjonInternEkstern;
    @XmlElement(name = "FeilSkjema", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataUtredning/v4_0")
