 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0}Meldingsinformasjon"/&gt;
 *         &lt;element ref="{http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0}Navigering"/&gt;
 *         &lt;element ref="{http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0}StdInfo"/&gt;
 *         &lt;element ref="{http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0}Laboratorium"/&gt;
 *         &lt;element ref="{http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0}Behandling"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class KliniskProstataKirurgi extends Melding {
    ...
    @XmlElement(name = "Meldingsinformasjon", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0", required = true)
    protected Meldingsinformasjon meldingsinformasjon;
    @XmlElement(name = "Navigering", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0", required = true)
    protected Navigering navigering;
    @XmlElement(name = "StdInfo", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0", required = true)
    protected StdInfo stdInfo;
    @XmlElement(name = "Laboratorium", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0", required = true)
    protected Laboratorium laboratorium;
    @XmlElement(name = "Behandling", namespace = "http://www.kreftregisteret.no/kremt/KliniskProstataKirurgi/v4_0", required = true)
